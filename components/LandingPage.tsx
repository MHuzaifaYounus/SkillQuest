  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-50 overflow-x-hidden selection:bg-blue-500/30 font-inter scroll-smooth">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-slate-950/80 backdrop-blur-md border-b border-slate-900 py-3' : 'bg-transparent py-6'}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8">
            <a href="#features" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-white transition-colors">Framework</a>
            ...
            <a href="#science" className="text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-white transition-colors">The Science</a>
          </nav>
        ...
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-16 lg:gap-8 relative z-10">
          ...
          <div className="flex-1 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-8 animate-in fade-in slide-in-from-left-4 duration-1000">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-blue-400">Powered by Gemini Pro 2.5</span>
            </div>
            ...
            <h1 className="text-5xl md:text-7xl xl:text-8xl font-black tracking-tighter mb-8 leading-[0.9] uppercase italic animate-in fade-in slide-in-from-left-8 duration-1000 delay-200">
              Become a <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-emerald-400">Modern Polymath.</span>
            </h1>
            ...
            <p className="max-w-2xl mx-auto lg:mx-0 text-lg md:text-xl text-slate-400 font-medium mb-12 animate-in fade-in slide-in-from-left-12 duration-1000 delay-300">
              Stop dabbling and start mastering. SkillQuest uses neural habit-stacking and AI architecture to transition your skills from daily practice to subconscious mastery.
            </p>
          ...
          {/* Right Content - Polymath Illustration */}
      ...
      <section id="how-it-works" className="py-20 md:py-32 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 reveal">
            <h2 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter mb-6">Execution Pipeline</h2>
            <p className="text-slate-500 max-w-xl mx-auto font-bold uppercase tracking-widest text-xs">Four steps from novelty to second nature</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 md:gap-8">
            {[
              { step: '01', title: 'Identify', desc: 'Select any skill from coding to calligraphy. The more niche, the better.', icon: '🎯' },
              { step: '02', title: 'Architect', desc: 'Gemini Pro builds a Tier 1 roadmap specifically for your current ability.', icon: '🏗️' },
              { step: '03', title: 'Execute', desc: 'Complete daily habits. Neural pathways thicken with every checkmark.', icon: '⚡' },
              { step: '04', title: 'Ascend', desc: 'Reach 100% to unlock higher tiers, culminating in passive mastery.', icon: '🚀' },
            ].map((item, i) => (
      ...
      <section id="features" className="py-20 md:py-32 px-6 bg-slate-900/20">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-20 reveal">
            <h2 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter mb-6">The Hierarchy of Competence</h2>
            <p className="text-slate-500 max-w-xl mx-auto font-bold uppercase tracking-widest text-xs">A structured framework for systematic progression</p>
          </div>
            ...
            {COLUMNS.map((col, idx) => (
              ...
              >
                ...
                <div className="pt-6 border-t border-white/5">
                  <span className="text-[10px] font-black uppercase tracking-widest opacity-50">Mastery Level {idx + 1}</span>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
          <div className="flex-1 reveal">
            <h2 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter leading-tight mb-8">
              The Science of <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-600">Cognitive Mastery.</span>
            </h2>
            <p className="text-lg text-slate-400 font-medium leading-relaxed mb-8">
              SkillQuest is built on the principles of Neuroplasticity and the Dreyfus model of skill acquisition. By forcing tiered progression, we prevent the "illusion of competence" and ensure deep understanding.
            </p>
            <div className="grid grid-cols-2 gap-8">
              <div>
                <div className="text-4xl font-black text-white mb-1 tracking-tighter">2.5X</div>
                <div className="text-[10px] font-black uppercase tracking-widest text-slate-500">Faster Skill Retention</div>
              </div>
              <div>
                <div className="text-4xl font-black text-white mb-1 tracking-tighter">74%</div>
                <div className="text-[10px] font-black uppercase tracking-widest text-slate-500">Lower Attrition Rate</div>
              </div>
            </div>
          </div>
          <div className="flex-1 grid grid-cols-1 gap-4 reveal stagger-2">
            {[
              { title: 'Habit Stacking', text: 'Daily drills anchor skills into existing routines.' },
              { title: 'AI Curated', text: 'Every tier transition triggers a fresh AI audit of your path.' },
              { title: 'Visual Feedback', text: 'See your neural pathways thicken through progress indicators.' }
            ].map((feature, i) => (
        ...
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-16">
            ...
            <div className="relative group">
              ...
              <div className="relative bg-slate-950 border border-slate-800 rounded-3xl p-6 shadow-2xl">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h4 className="font-black text-xs uppercase tracking-widest text-slate-100">AI Architect v2</h4>
                    <p className="text-[10px] font-bold text-slate-500 uppercase tracking-tighter">Analyzing Current Meta</p>
                  </div>
                </div>
                <div className="space-y-4">
                  <div className="bg-slate-900/80 rounded-xl p-4 border border-slate-800">
                    <div className="text-[8px] font-black uppercase tracking-widest text-slate-600 mb-2">Request</div>
                    <div className="text-xs font-semibold text-blue-400">"Build Beginner Roadmap for Quantum Computing..."</div>
                  </div>
                  <div className="bg-slate-900/80 rounded-xl p-4 border border-slate-800">
                    <div className="flex justify-between items-center mb-2">
                       <div className="text-[8px] font-black uppercase tracking-widest text-emerald-500">Output Generated</div>
                       <div className="text-[8px] font-black text-slate-700">0.8s</div>
                    </div>
          ...
          <div className="flex-1 order-1 md:order-2 reveal stagger-2">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-purple-500/10 border border-purple-500/20 mb-8">
              ...
              <span className="text-[10px] font-black uppercase tracking-widest text-purple-400">Automated Mentorship</span>
            </div>
            <h2 className="text-4xl md:text-6xl font-black uppercase italic tracking-tighter leading-tight mb-8">
              Every Goal <br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-emerald-400">Has a Map.</span>
            </h2>
            <p className="text-lg text-slate-400 font-medium leading-relaxed mb-8">
              Traditional to-do lists fail because they lack hierarchy. SkillQuest uses Gemini Pro to decompose complex skills into atomic, manageable daily actions.
            </p>
            <button 
              onClick={onSignupClick}
      ...
      <section className="py-20 md:py-48 px-6 bg-slate-950 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10 reveal">
          ...
          <p className="text-slate-400 mb-12 text-lg font-medium">Join 5,000+ polymaths building their personal nexus.</p>
          <button 
            onClick={onSignupClick}
          ...
          <div className="mt-32 flex flex-col md:flex-row items-center justify-between gap-8 border-t border-slate-900 pt-10">
            ...
            <div className="flex items-center gap-8">
              <a href="#" className="text-[10px] font-black uppercase tracking-widest text-slate-600 hover:text-white transition-colors">Documentation</a>
              <a href="#" className="text-[10px] font-black uppercase tracking-widest text-slate-600 hover:text-white transition-colors">Changelog</a>
              <a href="#" className="text-[10px] font-black uppercase tracking-widest text-slate-600 hover:text-white transition-colors">Neural Status</a>
            </div>
          </div>
        </div>
      </section>
